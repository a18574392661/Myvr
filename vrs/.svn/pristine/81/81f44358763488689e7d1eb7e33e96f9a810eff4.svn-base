...
( function( root, factory ) {
    ...
    var tpl = [
        '<div class="cal-wrap">',
            '<div class="month cell-center"><div id="prevMonth" class="iconfont icon-fangxiang-xiangzuo margin-center"></div><h2>{%date%}</h2><div id="nextMonth" class="iconfont icon-fangxiang-xiangyou margin-center"></div></div>',
            '{%week%}',
            '<ul class="day">',
                '{%day%}',
            '</ul>',
