var util = {
	options: {
		ACTIVE_COLOR: "#0077EB",
		NORMAL_COLOR: "#000",
		subpages: ["/html/share/share_images_list.html","/tab/baoming.html","/html/exam/km1_index.html", "/tab/wode.html"],
		//subpages: ["tab/lianche.html","tab/baoming.html","html/exam/km1_index.html", "tab/wode.html"]
		//subpageTitles: ["约练车","报名","驾考","我的"]
	},
	/**
	 *  简单封装了绘制原生view控件的方法
	...
	initSubpage: function(aniShow) {
		...
		for(var i = 0, len = subpages.length; i < len; i++) {
			if(!plus.webview.getWebviewById(subpages[i]) && i != 1 ) {
